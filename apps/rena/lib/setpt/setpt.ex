...
defmodule Rena.SetPt do
  alias Rena.SetPt.Server
  ...
  defmacro __using__(use_opts) do
    quote location: :keep do
      def child_spec(start_args) do
        ...
        all_args = [use_opts: use_rest, name: module, start_args: start_args]

        Supervisor.child_spec({Server, all_args}, [id: module] ++ child_args)
      end
