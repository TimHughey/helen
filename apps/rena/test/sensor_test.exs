defmodule Rena.Sensor.SensorTest do
  ...
  describe "Rena.Sensor.range_compare/3" do
    ...
    test "creates accurate summary", %{range: range} do
      ...
      good = %Result{gt_mid: true, gt_high: true, invalid: 1, lt_low: true, lt_mid: true, valid: 4}
