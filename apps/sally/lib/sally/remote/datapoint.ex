defmodule Sally.Remote.DB.Datapoint do
  @moduledoc """
  Database functionality for Sally.Remote DataPoint
  """
  ...
  alias Sally.Remote.DB.Datapoint, as: Schema
  alias Sally.Repo

  schema "remote_datapoint" do
  ...
  defp columns(:required), do: columns_all(only: [:alias_id, :reading_at])
