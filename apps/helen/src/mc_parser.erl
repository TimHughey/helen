...
-file("src/mc_parser.yrl", 75).
yeccpars2_34_(__Stack0) ->
 [__2,__1 | __Stack] = __Stack0,
 [begin
   # { worker_name => value ( __1 ) , cmd => value ( __2 ) }
  end | __Stack].

-compile({inline,yeccpars2_35_/1}).
-file("src/mc_parser.yrl", 79).
yeccpars2_35_(__Stack0) ->
 [__2,__1 | __Stack] = __Stack0,
 [begin
   # { cmd => value ( __1 ) , worker_name => __2 }
  end | __Stack].

-compile({inline,yeccpars2_36_/1}).
-file("src/mc_parser.yrl", 117).
...
-file("src/mc_parser.yrl", 83).
yeccpars2_40_(__Stack0) ->
 [__3,__2,__1 | __Stack] = __Stack0,
 [begin
   # { cmd => value ( __1 ) , worker_name => value ( __2 ) , mode => value ( __3 ) }
  end | __Stack].

-compile({inline,yeccpars2_41_/1}).
-file("src/mc_parser.yrl", 87).
yeccpars2_41_(__Stack0) ->
 [__2,__1 | __Stack] = __Stack0,
 [begin
   # { cmd => value ( __1 ) , worker_name => nil , for => value ( __2 ) }
  end | __Stack].

-compile({inline,yeccpars2_43_/1}).
-file("src/mc_parser.yrl", 114).
...
-file("src/mc_parser.yrl", 96).
yeccpars2_48_(__Stack0) ->
 [__6,__5,__4,__3,__2,__1 | __Stack] = __Stack0,
 [begin
   # { worker_name => value ( __1 ) , cmd => value ( __2 ) ,
    for => value ( __4 ) , then => value ( __6 ) }
  end | __Stack].

-compile({inline,yeccpars2_49_/1}).
-file("src/mc_parser.yrl", 91).
yeccpars2_49_(__Stack0) ->
 [__7,__6,__5,__4,__3,__2,__1 | __Stack] = __Stack0,
 [begin
   # { worker_name => value ( __1 ) , cmd => value ( __2 ) ,
    for => value ( __4 ) , then => value ( __6 ) , nowait => true }
  end | __Stack].

-compile({inline,yeccpars2_50_/1}).
-file("src/mc_parser.yrl", 106).
yeccpars2_50_(__Stack0) ->
 [__3,__2,__1 | __Stack] = __Stack0,
 [begin
   # { worker_name => value ( __1 ) , cmd => value ( __2 ) , number => value ( __3 ) }
  end | __Stack].

-compile({inline,yeccpars2_51_/1}).
-file("src/mc_parser.yrl", 71).
...
-file("src/mc_parser.yrl", 65).
yeccpars2_52_(__Stack0) ->
 [__5,__4,__3,__2,__1 | __Stack] = __Stack0,
 [begin
   { step , # { name => value ( __2 ) , actions => __4 } }
  end | __Stack].

-compile({inline,yeccpars2_56_/1}).
-file("src/mc_parser.yrl", 61).
yeccpars2_56_(__Stack0) ->
 [__7,__6,__5,__4,__3,__2,__1 | __Stack] = __Stack0,
 [begin
   { step , # { name => value ( __2 ) , for => value ( __4 ) , actions => __6 } }
  end | __Stack].

-compile({inline,yeccpars2_57_/1}).
-file("src/mc_parser.yrl", 57).
...
-file("src/mc_parser.yrl", 21).
yeccpars2_60_(__Stack0) ->
 [__5,__4,__3,__2,__1 | __Stack] = __Stack0,
 [begin
   { mode , # { name => value ( __2 ) , details => __4 } }
  end | __Stack].

-compile({inline,yeccpars2_66_/1}).
-file("src/mc_parser.yrl", 123).
...
-file("src/mc_parser.yrl", 25).
yeccpars2_73_(__Stack0) ->
 [__7,__6,__5,__4,__3,__2,__1 | __Stack] = __Stack0,
 [begin
   { value ( __1 ) , # { cmd => value ( __2 ) , name => value ( __3 ) ,
    type => value ( __4 ) , details => __6 } }
  end | __Stack].

-compile({inline,yeccpars2_74_/1}).
-file("src/mc_parser.yrl", 14).
