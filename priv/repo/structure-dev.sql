...
ALTER TABLE ONLY public.pwm_cmd
    ADD CONSTRAINT pwm_cmd_pwm_id_fkey FOREIGN KEY (pwm_id) REFERENCES public.pwm_device(id) ON UPDATE CASCADE ON DELETE CASCADE;
